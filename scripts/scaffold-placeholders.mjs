...
const pages = [
  ...
  /* common core ela leaf examples ----------------------------- */
  {
    ...
    description: "Summary of the Grade 9-10 writing standards, with classroom examples, rubric language, and citations.",
  ...
  },
  {
    ...
    description: "What W.9-10.1 says, what it means, and how to teach and assess argument writing in grades 9-10.",
  ...
  },
  {
    ...
    description: "What W.9-10.2 says, what it means, and how to teach and assess informative writing in grades 9-10.",
  ...
  },
  {
    ...
    description: "What HS-LS1-1 says with classroom examples and the underlying disciplinary core idea, practice, and crosscutting concept.",
