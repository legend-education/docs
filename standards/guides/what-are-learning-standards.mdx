...
<CardGroup cols={2}>
  <Card title="Standards vs. curriculum vs. rubrics" icon="layers" href="/standards/guides/standards-vs-curriculum-vs-rubrics">
  ...
  <Card title="Browse all U.S. standards" icon="library" href="/standards">
