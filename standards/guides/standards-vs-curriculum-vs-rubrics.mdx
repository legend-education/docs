...
description: "A guide to the difference between learning standards, curriculum, and rubrics — what each one is, who owns it, and how they connect."
...
<Frame caption="One road, four moving parts: curriculum, instruction, rubric, standard.">
  <img src="/images/road-trip-analogy.png" alt="A horizontal infographic titled 'A road trip is a classroom.' A single winding road connects four illustrated cards from left to right: a folded paper map labeled 'The route — Curriculum,' a small red car labeled 'How you drive today — Instruction,' a postcard labeled 'The postcard home — Rubric,' and a flag on a sunlit hilltop labeled 'The destination — Standard.'" />
</Frame>
