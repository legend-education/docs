...
<CardGroup cols={3}>
  <Card title="Standard" icon="flag">
    ...
    **Example:** _Write arguments to support claims using valid reasoning and sufficient evidence._ (`W.9-10.1`)
  </Card>
  ...
  <Card title="Curriculum" icon="map">
    ...
    **Example:** _Unit 3, "Argument and Evidence" — read three op-eds, draft a 1,200-word essay, peer review, revise, submit._
  </Card>
  ...
  <Card title="Rubric" icon="ruler">
    ...
    **Example:** _4 = answers a strong counterclaim with specific evidence. 3 = acknowledges a counterclaim. 2 = ignores counterclaim. 1 = no claim._
  </Card>
</CardGroup>
...
<div class="citation">
  <dl>
    ...
    <dd>
      ...
      Southern Regional Education Board — <a href="https://www.sreb.org/sites/main/files/file-attachments/2022standards_vs_curriculum_page1.pdf">Standards vs. Curriculum</a>
    </dd>

    <dt>Standards referenced</dt>
    ...
    <dd>
      ...
      Next Generation Science Standards — <a href="https://www.nextgenscience.org/">NGSS home</a>
    </dd>
